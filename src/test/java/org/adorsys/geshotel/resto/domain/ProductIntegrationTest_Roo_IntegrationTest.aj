...
privileged aspect ProductIntegrationTest_Roo_IntegrationTest {
    ...
    public void ProductIntegrationTest.testCountProducts() {
        ...
        long count = org.adorsys.geshotel.resto.domain.Product.countProducts();
    ...
    public void ProductIntegrationTest.testFindProduct() {
        org.adorsys.geshotel.resto.domain.Product obj = dod.getRandomProduct();
        ...
        obj = org.adorsys.geshotel.resto.domain.Product.findProduct(id);
    ...
    public void ProductIntegrationTest.testFindAllProducts() {
        ...
        java.util.List<org.adorsys.geshotel.resto.domain.Product> result = org.adorsys.geshotel.resto.domain.Product.findAllProducts();
    ...
    public void ProductIntegrationTest.testFindProductEntries() {
        ...
        java.util.List<org.adorsys.geshotel.resto.domain.Product> result = org.adorsys.geshotel.resto.domain.Product.findProductEntries(0, (int) count);
    ...
    public void ProductIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyProduct(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.adorsys.geshotel.resto.domain.Product merged =  obj.merge();
        obj.flush();
    ...
    public void ProductIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Product' failed to initialize correctly", dod.getRandomProduct());
        org.adorsys.geshotel.resto.domain.Product obj = dod.getNewTransientProduct(Integer.MAX_VALUE);
    ...
    public void ProductIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Product' with identifier '" + id + "'", org.adorsys.geshotel.resto.domain.Product.findProduct(id));
    }
