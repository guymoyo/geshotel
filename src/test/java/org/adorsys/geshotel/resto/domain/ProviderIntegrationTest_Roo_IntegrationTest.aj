...
import org.adorsys.geshotel.resto.domain.ProviderDataOnDemand;
...
privileged aspect ProviderIntegrationTest_Roo_IntegrationTest {
    ...
    public void ProviderIntegrationTest.testCountProviders() {
        ...
        long count = org.adorsys.geshotel.resto.domain.Provider.countProviders();
    ...
    public void ProviderIntegrationTest.testFindProvider() {
        org.adorsys.geshotel.resto.domain.Provider obj = dod.getRandomProvider();
        ...
        obj = org.adorsys.geshotel.resto.domain.Provider.findProvider(id);
    ...
    public void ProviderIntegrationTest.testFindAllProviders() {
        ...
        java.util.List<org.adorsys.geshotel.resto.domain.Provider> result = org.adorsys.geshotel.resto.domain.Provider.findAllProviders();
    ...
    public void ProviderIntegrationTest.testFindProviderEntries() {
        ...
        java.util.List<org.adorsys.geshotel.resto.domain.Provider> result = org.adorsys.geshotel.resto.domain.Provider.findProviderEntries(0, (int) count);
    ...
    public void ProviderIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyProvider(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.adorsys.geshotel.resto.domain.Provider merged =  obj.merge();
        obj.flush();
    ...
    public void ProviderIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Provider' failed to initialize correctly", dod.getRandomProvider());
        org.adorsys.geshotel.resto.domain.Provider obj = dod.getNewTransientProvider(Integer.MAX_VALUE);
    ...
    public void ProviderIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Provider' with identifier '" + id + "'", org.adorsys.geshotel.resto.domain.Provider.findProvider(id));
    }
