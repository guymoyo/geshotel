...
privileged aspect CustomerIntegrationTest_Roo_IntegrationTest {
    ...
    public void CustomerIntegrationTest.testCountCustomers() {
        ...
        long count = org.adorsys.geshotel.domain.Customer.countCustomers();
    ...
    public void CustomerIntegrationTest.testFindCustomer() {
        org.adorsys.geshotel.domain.Customer obj = dod.getRandomCustomer();
        ...
        obj = org.adorsys.geshotel.domain.Customer.findCustomer(id);
    ...
    public void CustomerIntegrationTest.testFindAllCustomers() {
        ...
        java.util.List<org.adorsys.geshotel.domain.Customer> result = org.adorsys.geshotel.domain.Customer.findAllCustomers();
    ...
    public void CustomerIntegrationTest.testFindCustomerEntries() {
        ...
        java.util.List<org.adorsys.geshotel.domain.Customer> result = org.adorsys.geshotel.domain.Customer.findCustomerEntries(0, (int) count);
    ...
    public void CustomerIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyCustomer(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.adorsys.geshotel.domain.Customer merged =  obj.merge();
        obj.flush();
    ...
    public void CustomerIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Customer' failed to initialize correctly", dod.getRandomCustomer());
        org.adorsys.geshotel.domain.Customer obj = dod.getNewTransientCustomer(Integer.MAX_VALUE);
    ...
    public void CustomerIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Customer' with identifier '" + id + "'", org.adorsys.geshotel.domain.Customer.findCustomer(id));
    }
