...
privileged aspect UserAccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserAccountIntegrationTest.testCountUserAccounts() {
        ...
        long count = org.adorsys.geshotel.domain.UserAccount.countUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccount() {
        org.adorsys.geshotel.domain.UserAccount obj = dod.getRandomUserAccount();
        ...
        obj = org.adorsys.geshotel.domain.UserAccount.findUserAccount(id);
    ...
    public void UserAccountIntegrationTest.testFindAllUserAccounts() {
        ...
        java.util.List<org.adorsys.geshotel.domain.UserAccount> result = org.adorsys.geshotel.domain.UserAccount.findAllUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccountEntries() {
        ...
        java.util.List<org.adorsys.geshotel.domain.UserAccount> result = org.adorsys.geshotel.domain.UserAccount.findUserAccountEntries(0, (int) count);
    ...
    public void UserAccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.adorsys.geshotel.domain.UserAccount merged =  obj.merge();
        obj.flush();
    ...
    public void UserAccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserAccount' failed to initialize correctly", dod.getRandomUserAccount());
        org.adorsys.geshotel.domain.UserAccount obj = dod.getNewTransientUserAccount(Integer.MAX_VALUE);
    ...
    public void UserAccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserAccount' with identifier '" + id + "'", org.adorsys.geshotel.domain.UserAccount.findUserAccount(id));
    }
